...
$app->group('/incident-reporting', function () {
    $this->get('/[params:.*]', "HospitalApi\Controller\IncidentReportingController:get", function (Request $req, Response $res, array $args) { });
    $this->get('/messages/[params:.*]', "HospitalApi\Controller\IncidentReportingController:getChatsByIncident", function (Request $req, Response $res, array $args) { });
    ...
    $this->get('/permission/[params:.*]', "HospitalApi\Controller\IncidentReportingController:gotPermissionAction", function (Request $req, Response $res, array $args) { });
